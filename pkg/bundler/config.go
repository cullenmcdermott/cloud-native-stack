...
// BundlerConfig provides configuration options for bundlers.
...
// DefaultBundlerConfig returns a BundlerConfig with default values.
...
func (c *BundlerConfig) Merge(other *BundlerConfig) {
	if other == nil {
		return
	}
